...
<li class="comment <?php if($comment->comment_author_email == get_the_author_email()) {echo 'admincomment';} else {echo 'regularcomment';} ?>" id="comment-<?php comment_ID() ?>">
			...
			<div class="comment-author">
					...
					<?php if (get_comment_author_url()) : ?>
						...
						<span class="reply" style="visibility:hidden;"><a href="#commentform" title="" onclick="document.getElementById('comment').value += '&lt;a href=&quot;#comment-<?php comment_ID() ?>&quot;&gt;@<?php comment_author();?> &lt;/a&gt;\n'"><img src="<?php bloginfo('template_url'); ?>/img/reply.gif" alt="Notify"/></a></span>
					<?php else : ?>
						<span class="fn" id="commentauthor-<?php comment_ID() ?>"><?php comment_author(); ?></span>
						<span class="reply" style="display:none;"><a href="#commentform" title="" onclick="document.getElementById('comment').value += '&lt;a href=&quot;#comment-<?php comment_ID() ?>&quot;&gt;@<?php comment_author();?> &lt;/a&gt;\n'"><img src="<?php bloginfo('template_url'); ?>/img/reply.gif" alt="Notify"/></a></span>
