...
function wpAppbox_createTabs( $currentTab = 'info' ) {
    ...
    echo( "<a class='nav-tab paypal dashicons-before dashicons-superhero-alt' target='blank' href='" . WPAPPBOX_URL_PAYPAL . "' ); ?>" . esc_html__('PayPal-Donation', 'wp-appbox') . "</a>" );
    echo( "<a class='nav-tab amazon dashicons-before dashicons-amazon' target='blank' href='" . WPAPPBOX_URL_AMAZON . "' ); ?>" . esc_html__('Amazon Wishlist', 'wp-appbox') . "</a>" );
    echo( '</h2>' );
}
