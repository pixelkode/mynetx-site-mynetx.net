...
<div style="position: relative;width:100%; top: 10px; height: auto; text-align: center; background-color:#f5d6a9;">
	...
	<img style="width:100%; max-width: 1100px; max-height: 600px;" src="<?php echo( plugins_url( 'img/wpappbox-logo.png', dirname( __FILE__ ) ) ); ?>" alt="<?php echo( WPAPPBOX_PLUGIN_NAME ); ?> (Version <?php echo( WPAPPBOX_PLUGIN_VERSION ); ?>)" title="<?php echo( WPAPPBOX_PLUGIN_NAME ); ?> (Version <?php echo( WPAPPBOX_PLUGIN_VERSION ); ?>)" />
</div>
<br clear="both" />
<small>
	<?php  
