<?php
	...
	$query = mysql_query('SELECT language_code FROM mx_icl_translations WHERE element_id = "'.addslashes($postid).'" AND element_type = "post_page"');
